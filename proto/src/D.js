...
const TEXT = new TextDecoder(),
	...
	/*@__NO_SIDE_EFFECTS__*/
	decodeInt64Based = (decodeFn) => (buf, pos) => {
...
export const string = metaSet(utf8d, ""),
	bytes = metaSet((buf) => buf, new Uint8Array()),
	...
	sint64 = /*@__NO_SIDE_EFFECTS__*/ v0_0(decodeSint64),
	sint64Li = /*@__NO_SIDE_EFFECTS__*/ liDecode(decodeSint64),
	uint32 = v0_0(decodeUint32),
	uint32Li = liDecode(decodeUint32),
	uint64 = v0_0(decodeUint64),
	uint64Li = liDecode(decodeUint64),
	map = (key, val) => [$([key, val])]

export const $ = (type_li_in) => {
	const default_li = []
	const type_li = []
